...
\033[1;94m ┈┈┈┈╲┊┊┊┊╱┈┈┈┈\033[1;94mRANA MANDOKHAIL.\033[1;91m┈┈┈┈╲┊┊┊┊╱┈┈┈┈

\033[1;96m ┈┈┈┈▕╲▂▂╱▏┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈▕╲▂▂╱▏┈┈┈┈

\033[1;96m ╱▔▔▔▔┊┊┊┊▔▔▔▔╲☞☞☞☞☞☞\033[1;91m☜☜☜☜☜╱▔▔▔▔┊┊┊┊▔▔▔▔╲

\033[1;96m................\033[1;93RANA MANDOKHAIL\033[1;91m...............
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/Rana')

	    os.system('cd $HOME && git clone https://github.com/Rana999/Mandokhail')
	    ...
	    psb('WhatsApp Num 03460237958✓')

	    psb('WellCome To Ayaa Anni')

	    psb('Congratulations AYAAN ANNI Tool Has Been Updated Successfully')

	    psb('🔓User Name☆ ayaan✓')

	    psb('🔓Password ☆ anni✓')

	    psb('facebook Ayaan Anni✓')
